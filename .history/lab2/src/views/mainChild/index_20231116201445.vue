<script setup lang="ts">
	import { defineAsyncComponent, ref, onActivated, onMounted, nextTick } from 'vue';
	...
	onMounted(() => {
		Comp.value.addEventListener('scroll', (e) => {
			console.log('滚动');
		});
	});
	onBeforeRouteLeave((to, from, next) => {
		nextTick(() => {
			console.log('ssss: ', Comp.value.scrollTop);
		});
		if (Comp.value) {
...
<template>
	<div ref="Comp" class="overflow-auto">
		<ArticleComp
			:type="meta.type"
