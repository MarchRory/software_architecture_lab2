...
<template>
	<div class="flex items-center justify-around w-full h-16 shadow-lg">
		<ul class="flex items-center justify-start list-none">
			<li class="flex items-center justify-center w-8 h-8 border-4 rounded-full border-l-gray-400">
