...
<style scoped>
	...
	ul li {
		cursor: pointer;
		@apply flex items-center border-2 border-zinc-200 justify-center px-4 py-5 rounded-lg font-mono font-bold text-xl mb-2 text-slate-800 hover:bg-teal-500 hover:text-white transition-all;
	}
</style>
