...
<style scoped>
	...
	ul li {
		cursor: pointer;
		@apply flex items-center justify-center px-4 py-5 rounded-lg font-mono font-bold text-xl mb-2 text-slate-800 hover:bg-teal-400 hover:text-white transition-all hover:border-transparent;
	}
</style>
