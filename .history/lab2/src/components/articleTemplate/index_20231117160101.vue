<script setup lang="ts">
	...
	const originStr = ref(
		'5464645645646545645645645645634163541563416541dfsgse brger sghear hera haerh eah ea 1he561h 5e6a1 hjn56e3s4 1hje5s14 hjn63erdst14hj 6ertjt 56dst',
	);
	const resStr = ref('');
	const fileInput = ref();
</script>
...
<style scoped>
	...
	.strBox {
		@apply w-5/12 h-96 overflow-auto px-4 py-4  rounded-lg bg-slate-700;
	}
	.strBox article {
		@apply text-slate-100 font-extralight text-xl mt-6 flex-wrap break-words;
	}
	.originStr::before {
		content: 'Origin';
	}
