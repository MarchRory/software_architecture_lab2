	...
	<div class="w-full font-mono h-fit" ref="ctx">
		...
		<main class="flex flex-col justify-around">
			...
			<div class="mb-24">
				...
				/>
				<div
					class="px-6 py-4 text-xl font-bold text-white transition-all border-0 border-transparent rounded-lg cursor-pointer hover:border-white bg-cyan-400 w-fit"
				>
					上传txt文件
				</div>
			</div>
