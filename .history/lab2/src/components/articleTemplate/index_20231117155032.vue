	...
	<div class="w-full font-mono h-fit" ref="ctx">
		...
		<main class="flex flex-col justify-around">
			...
			<div class="mb-24">
				...
				<div
					class="flex items-center justify-between w-10/12 h-fit bg-cyan-400"
					style="margin: 2rem auto"
				>
					<div class="strBox">{{ originStr }}</div>
					<div class="strBox">{{ resStr }}</div>
				</div>
			</div>
		</main>
	</div>
...
<style scoped>
	...
	.strBox {
		@apply w-5/12 h-10 overflow-auto rounded-lg bg-slate-700;
	}
</style>
