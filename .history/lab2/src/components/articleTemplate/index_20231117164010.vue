...
<style scoped>
	...
	.strBox {
		@apply w-5/12 h-96 px-2 py-2  rounded-lg bg-slate-700;
	}
	.strBox article {
		margin: 0 auto;
		@apply text-slate-100 font-extralight text-xl mt-6 flex-wrap break-words w-11/12 h-4/6 overflow-auto bg-violet-400;
	}
	.originStr::before {
		content: 'Origin';
	}
