...
<template>
	<div class="w-full font-mono h-fit" ref="ctx">
		<div class="flex flex-col items-center mb-12">
			<div id="top" ref="title" class="mt-24 mb-8 font-sans text-5xl font-bold text-center w-fit">
				{{ type }}
			</div>
			<div
		...
		<div class="fixed transition-all bottom-44 left-5/6">
			<ul>
				<li v-for="(anchorItem, index) in anchor" :key="index">
					<a :href="anchorItem.anchorSeletor">{{ anchorItem.name }}</a>
				</li>
