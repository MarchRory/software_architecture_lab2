...
<style scoped>
	...
	.strBox {
		@apply w-5/12 h-96 px-4 py-4  rounded-lg bg-slate-700;
	}
	.strBox article {
		@apply text-slate-100 font-extralight text-xl mt-6 flex-wrap break-words w-11/12 ml-auto h-4/6 overflow-auto bg-violet-400;
	}
	.originStr::before {
		content: 'Origin';
	}
